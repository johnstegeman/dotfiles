# Generated by Powerlevel10k configuration wizard on 2025-01-17 at 10:05 EST.
...
() {
  ...
  #####################################[ vcs: git status ]######################################
  # Branch icon. Set this parameter to '\UE0A0 ' for the popular Powerline branch icon. (was \uF126)
