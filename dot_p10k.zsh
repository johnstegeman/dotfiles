# Generated by Powerlevel10k configuration wizard on 2021-11-16 at 09:00 EAT.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n@'`echo $host`
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n@'`echo $host`
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n@'`echo $host`
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|ass|ags'
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon context kubecontext virtualenv pyenv vpn_ip root_indicator direnv dir)
